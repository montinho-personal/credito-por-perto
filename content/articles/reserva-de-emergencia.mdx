...
featuredImage: "/images/articles/reserva-de-emergencia-capa.webp"
imageAlt: "Pote de vidro com cédula e moedas empilhadas diante de um escudo, com sinal de adição ao lado."
imageWidth: 1600
imageHeight: 900
...
<ToolCallout id="parcela-no-orcamento" note="Para enxergar quanto sobra hoje — e o que uma parcela nova faria com essa folga." />
...
<ToolCallout id="a-vista-ou-parcelado" note="Antes de usar a reserva para aproveitar um desconto à vista, veja o tamanho real dessa diferença." />
...
Entrada maior reduz o valor financiado e os juros do contrato, mas zerar a reserva troca um risco por outro: o primeiro imprevisto depois da mudança volta para o crédito caro. O trade-off está detalhado em [quanto da renda comprometer com o financiamento de um imóvel](/organizacao-financeira/quanto-da-renda-comprometer-financiamento-imovel/).
