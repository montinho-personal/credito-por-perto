...
- **Consultar o que o sistema financeiro registra.** O [Registrato](https://registrato.bcb.gov.br), do Banco Central, mostra de graça suas operações de crédito ativas. Vale conferir antes de pedir um empréstimo. Assim você sabe o que a instituição verá.
