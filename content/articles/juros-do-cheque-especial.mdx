...
featuredImage: "/images/articles/juros-do-cheque-especial-capa.webp"
imageAlt: "Cartão de conta com saldo negativo ao lado de um símbolo de porcentagem, e barras crescentes que terminam num bloco escuro marcado como custo alto, com sinal de alerta."
imageWidth: 1600
imageHeight: 900
...
- Na prática do mercado, a maioria dos bancos cobra exatamente o teto — 8% não virou média, virou preço. A média oficial da modalidade, mês a mês, está no [Radar de taxas](/taxas/).
...
| Crédito pessoal comum | bem menor | compare na hora em [Minha taxa está cara?](/calculadoras/minha-taxa-esta-cara/) ou consulte [a média do BC](/juros-e-cet/como-consultar-taxa-media-do-bc/) |
...
<ToolCallout id="plano-para-sair-das-dividas" note="Cheque especial e cartão costumam andar juntos. Colocar as duas dívidas lado a lado mostra qual consome mais por mês." />
