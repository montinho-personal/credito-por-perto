...
featuredImage: "/images/articles/deposito-antecipado-e-golpe-capa.webp"
imageAlt: "Depósito antecipado para liberar empréstimo é golpe? Sim — entenda por quê; escudo de alerta e símbolo de proibido sobre pagamento antecipado via Pix"
contentType: "safety"
---
...
<ArticleImage
  src="/images/articles/golpe-deposito-mecanica.webp"
  alt="A mecânica do golpe do crédito em 3 atos: 1) promessa de crédito aprovado, com oferta fácil e aprovação garantida por anúncio, mensagem ou ligação; 2) pedido de taxa de cadastro, seguro ou caução via Pix — é o sinal do golpe; 3) o dinheiro nunca chega: após o pagamento, o golpista inventa desculpas, some ou bloqueia o contato. Custos legítimos saem do valor liberado ou entram nas parcelas — nunca antes"
  caption="Os três atos do golpe: promessa, cobrança antecipada, sumiço. Custos legítimos nunca vêm antes da liberação."
/>

## Se a oferta parece legítima, faça o teste em dois passos

1. **Peça tudo por escrito** — instituição, CNPJ, CET, valor líquido a receber — e verifique se a instituição é [autorizada pelo Banco Central](/credito-seguro/como-consultar-se-instituicao-e-autorizada/) (a [consulta por nome ou CNPJ](/calculadoras/consultar-instituicao/) faz isso em segundos, com os dados oficiais do BC);
...
Pediram dinheiro para liberar o crédito? Antes de pagar, rode a [verificação de sinais de golpe](/calculadoras/sinais-de-golpe/): ela cruza a sua situação com os sinais deste guia em menos de um minuto.
