...
- **Dados vazados são munição.** Já teve documentos expostos? Monitore o [Registrato](https://registrato.bcb.gov.br). O extrato do Banco Central mostra toda operação de crédito aberta no seu CPF;
